...
import { MdPrivacyTip as PrivacyLogo } from "react-icons/md";
import { IoDocumentText as TermsLogo } from "react-icons/io5";
    ...
    <>
        <IconContext.Provider value={{ color: "#f5f5f5", width: "40px"}}>
            ...
            <div className='w-full flex flex-row lg:px-20 items-between md:items-center justify-center fixed top-0 right-0 left-0 bg-[#3A3A3D] z-10'>
                <div className='flex items-center justify-evenly text-xs sm:text-xl h-[100px] sm:h-[120px] w-full text-white max-w-[900px]'>
                    ...
                    <Link to='/privacy' className='flex flex-col justify-center items-center hover:scale-110 duration-100'>
                        <PrivacyLogo className='nav-icon'/>
                        <div className='pt-1 sm:pt-3'>Privacy</div>
                    </Link>
                    <Link to='/terms' className='flex flex-col justify-center items-center hover:scale-110 duration-100'>
                        <TermsLogo className='nav-icon'/>
                        <div className='pt-1 sm:pt-3'>Terms</div>
                    </Link>
